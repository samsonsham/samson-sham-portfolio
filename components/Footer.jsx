        ...
        <Stack direction={"row"} spacing={6}>
          ...
          >
            <IconButton
              ...
              mx={4}
              as="a"
              href="https://www.linkedin.com/in/samson-sham"
              aria-label="LinkedIn"
              icon={<FaLinkedin fontSize={iconFontSize} />}
            />
            <IconButton
              _hover={{
                color: useColorModeValue("blackAlpha.600", "whiteAlpha.600"),
              ...
              mx={4}
              as="a"
              href="https://github.com/samsonsham"
              aria-label="GitHub"
            ...
            <IconButton
              ...
              mx={4}
              as="a"
              href="https://dev.to/samsonsham"
              aria-label="Devto"
              icon={<FaDev fontSize={iconFontSize} />}
            />
            <IconButton
              _hover={{
                color: useColorModeValue("blackAlpha.600", "whiteAlpha.600"),
              ...
              mx={4}
              as="a"
              href="https://twitter.com/samson_sham"
              aria-label="Twitter"
              icon={<FaTwitter fontSize={iconFontSize} />}
            />
          </ButtonGroup>
        </Stack>
      </Container>
